...
describe('UpdateClientUseCase', () => {
  ...
  it('should update a client successfully', async () => {
    ...
    const result = await updateClientUseCase.execute(existingClient.id, updateData);
    ...
    expect(mockClientRepository.update).toHaveBeenCalledWith('1', expect.any(Object));
  });
  ...
  it('should return error when client is not found', async () => {
    ...
    const result = await updateClientUseCase.execute('999', updateData);
